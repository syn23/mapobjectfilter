            ...
            <div class="map_filter_hidden--item">
                ...
                <div class="map_filter_hidden--data map_filter_hidden--range-wrap">
                    <div class="range" data-min="<?= $arResult['OBJECT_PROP']['PRICE']['MIN'] ?>"
                        ...
                        <input type="text" data-value="min" name="ref[COMMERCIAL][PROPERTY_PRICE][MIN]"
                               value="<?= $arResult['OBJECT_PROP']['PRICE']['MIN'] ?>">
                        <input type="text" data-value="max" name="ref[COMMERCIAL][PROPERTY_PRICE][MAX]"
                ...
                <div class="map_filter_hidden--data">
                    <? foreach ($arResult['OBJECT_PROP']['DEAL']['VALUE'] as $value) { ?>
                        <label class="checkbox">
                            <input type="radio" name="ref[C][DEAL]" value="<?= $value["ID"] ?>">
                            <?= $value["VALUE"] ?>
                        </label>
                    <? } ?>
                </div>
...
*/?>
        ...
        <div class="map_filter_hidden--row">
            <div class="map_filter_hidden--item">
                ...
                <div class="map_filter_hidden--data">
                    <label class="checkbox"><input type="checkbox" name="ref[C][PHOTO]" value="true"><span></span>
                    с фото</label>
                </div>
            </div>
        </div>

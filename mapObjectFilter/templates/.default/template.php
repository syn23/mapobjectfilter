...
Asset::getInstance()->addJs($templateFolder . "/mapFilter.js");
Asset::getInstance()->addJs($templateFolder . "/mapFilterYandexMap.js");
...
<section class="map_filter">
    ...
    <div class="map_filter--base">
        ...
        <form class="map_filter_hidden" data-wrap-filter data-type="apartment" method="post">
            <?include 'apartment.php'?>
        </form>
        <form class="map_filter_hidden" data-wrap-filter data-type="house" method="post">
        <?include 'house.php'?>
        </form>
        <form class="map_filter_hidden" data-wrap-filter data-type="commercial" method="post">
            <?include 'commercial.php'?>
        </form>
        <form class="map_filter_hidden" data-wrap-filter data-type="land_plot" method="post">
    ...
    <script>
        ...
        */?>
        var objectsMap = new mapFilterYandexMap();
    </script>

    ...
    window.mapFilter.prototype = {
        init: function(){
            ...
            this.$root.submit(function (e) {
                ...
                $(this).addClass('ready');
                $this.sendFilter();
                $('.map_filter--base').removeClass('active_mobile');
                $('.map_filter_hidden').removeClass('active');
                return false;
            });
        },
        ...
        addEventChangeFilter: function () {
            ...
            this.$root.find('.reset').on('click', function(e){
                ...
                var data_type = target_form.data('type');
                $('.map_filter--base_btn[data-filter="' + data_type + '"]').removeClass('active');
            });
            ...
            $('.map_filter--expanded_filter a').on('click', function(event){
                ...
                if($target.is('.active')){
                    ...
                    $('.map_filter--base').addClass('active_mobile');
                }
            });
